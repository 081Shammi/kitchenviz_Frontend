          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col flex-1 p-4">
                <div className="font-bold text-base sm:text-lg text-black mb-0.5">
                  {product.name}
                </div>
                <div className="text-[13px] text-gray-600 mb-3 truncate">{product.description}</div>
                <div className="flex items-end flex-wrap mb-2">
                  <span className="text-xl sm:text-2xl font-bold text-black mr-2">₹{sellingPrice}</span>
                  {hasDiscount && (
                    <span className="text-gray-400 line-through text-sm mt-1 mr-2">₹{product.price}</span>
                  )}
                  {hasDiscount && (
