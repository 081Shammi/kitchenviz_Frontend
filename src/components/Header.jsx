...
export default function Header() {
  ...
  // const baseText = scrolled ? "text-gray-900" : "text-white";
  // const baseHover = scrolled ? "hover:text-yellow-600" : "hover:text-yellow-300";
  const baseText = scrolled ? "text-gray-900" : "text-gray-900";
  const baseHover = scrolled ? "hover:text-yellow-600" : "hover:text-yellow-300";
...
>
      ...
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 h-26">
        {/* Logo */}
        <a href="/" className="flex items-center">
          <img
            src="/assets/logo1.jpg"
...
<button
  aria-label="Cart"
  onClick={() => navigate("/cart")}
  className="relative transition text-gray-900 hover:text-yellow-500 mr-1 md:mr-0"
...
>
  <svg
    ...
    strokeWidth={2.2}
    viewBox="0 0 24 24"
    style={{ color: "#1a1a1a" }} // always dark color
  >
    <circle cx="8" cy="21" r="1" />
    <circle cx="19" cy="21" r="1" />
    <path d="M2.05 2.05h2l2.66 12.42a2 2 0 002 1.58h9.78a2 2 0 001.95-1.57l1.65-7.43H5.12" />
