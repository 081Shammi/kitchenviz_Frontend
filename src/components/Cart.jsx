...
export default function CartPage() {
    ...
    // MATCHING ON product.id INSTEAD OF _id
    ...
    // MATCHING ON product.id (not _id!)
    ...
    if (loading) {
        return (
            <div className="w-full flex justify-center items-center min-h-[300px] text-lg">
                Loading...
            </div>
        );
    }
        ...
        return (
            <>
                ...
                <div className="w-full min-h-[50vh] flex flex-col justify-center items-center py-16 bg-white px-2">
                    <div className="bg-white border border-gray-200 shadow-lg rounded-2xl px-10 py-10 flex flex-col items-center max-w-xl w-full">
                        {/* Icon */}
                        <div className="mb-6">
                        ...
                        <p className="text-gray-500 mb-7">
                            ...
                            <br />
                            Start shopping for amazing deals and products!
                        </p>
                        <Link to="/products">
                            <button className="bg-yellow-400 hover:bg-yellow-300 text-black rounded-lg px-7 py-2 text-base font-semibold shadow-lg transition">
                                Shop Products
                            </button>
                        </Link>
                    </div>
    ...
    return (
        <>
            <Header />
            <div className="max-w-2xl mx-auto my-10 p-4 rounded-xl bg-white shadow">
                <h2 className="text-2xl font-bold mb-6">Shopping Cart</h2>
                <div className="divide-y border rounded-lg shadow-sm">
                    {displayedProducts.map((product) => {
                        const qty = getCartQuantity(product.id); // <-- HERE!
                            ...
                            <div key={product.id} className="flex items-center gap-4 py-4 px-2">
                                ...
                                <div className="flex flex-col items-center min-w-[120px]">
                                    <div className="flex items-center gap-2 mb-2">
                                        <button
                                            className="w-7 h-7 rounded-full bg-gray-100 text-xl font-bold"
                                    ...
                                    <button
                                        ...
                                        className="p-2 rounded-full hover:bg-red-50 active:bg-red-100 transition group"
                                        onClick={() => removeItem(product.id)}
                                        style={{
                                            display: "flex",
                                            alignItems: "center",
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center mt-8 gap-2">
                    ...
                    <button
                        className="bg-yellow-400 text-black font-bold px-8 py-3 rounded-lg shadow hover:bg-yellow-300 text-base"
